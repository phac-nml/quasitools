...
SHANNON_ENTROPY_NUMBER_NORMALIZED_TO_N = 4
SHANNON_ENTROPY_NUMBER_NORMALIZED_TO_H = 5
SIMPSON_INDEX = 6
...
MEASUREMENTS_NAMES = {
    ...
    SHANNON_ENTROPY_NUMBER_NORMALIZED_TO_N: "Shannon Entropy Localized to N",
    SHANNON_ENTROPY_NUMBER_NORMALIZED_TO_H: "Shannon Entropy Localized to H",
